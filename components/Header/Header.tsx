...
const Header = () => {
  const links = [
    {
      name: "Twitter",
      url: "http://twitter.com/theoplawinski",
      icon: (
        <svg
          width="24"
          height="24"
    ...
    {
      name: "Github",
      url: "https://github.com/theoplawinski/ui-components",
      icon: (
        <svg
          width="24"
          height="24"
        ...
        <ul className={css.links}>
          {links.map((link, i) => (
            <li className={css.linkItem} key={i}>
              <a className={css.link} href={link.url} target="_blank" rel="noopener noreferrer">
                {link.icon}
              </a>
            </li>
          ))}
